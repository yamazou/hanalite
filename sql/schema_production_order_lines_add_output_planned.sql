-- Per process line: output item and planned quantity (overrides order header when set)
...
-- Wrong backfill: FG parent_item_id on every line hides process step outputs.
UPDATE prd_order_lines l
INNER JOIN prd_orders o ON o.production_order_id = l.production_order_id
